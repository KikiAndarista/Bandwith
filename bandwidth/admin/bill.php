<?php
  ...
  if(isset($_POST['packet_used'])){
    $con->query("UPDATE users 
      SET packet_used='".$_POST['packet_used']."',billing_plan='".$_POST['biling_plan']."'  
      WHERE id = '".$_POST['id']."'
      ");
    echo $con->error;
  }
...
<div style="margin-left:100px">
    <form method="POST" >
      ...
      <input type="number" name="packet_used"><br><br>
      <label>Billing Plan:</label>
      <select name="biling_plan">
        <option value="5">5menit</option>
        <option value="10">10menit</option>
      </select><br><br>
